 ...
 */
@Mapper(componentModel = "spring", uses = {ParcelleMapper.class, LotissementMapper.class, NatureMapper.class, ActiviteMapper.class, UsageMapper.class, ProprietaireMapper.class})
public interface DossierMapper extends EntityMapper<DossierDTO, Dossier> {
    ...
    @Mapping(target = "categorieClotures", ignore = true)
    @Mapping(target = "removeCategorieCloture", ignore = true)
