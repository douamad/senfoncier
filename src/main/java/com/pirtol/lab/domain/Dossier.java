...
public class Dossier implements Serializable {
    ...
    @OneToMany(mappedBy = "dossier")
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    private Set<CategorieCloture> categorieClotures = new HashSet<>();

    @ManyToMany
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    @JoinTable(name = "dossier_parcelle",
    ...
    public Set<CategorieCloture> getCategorieClotures() {
        return categorieClotures;
    }

    public Dossier categorieClotures(Set<CategorieCloture> categorieClotures) {
        this.categorieClotures = categorieClotures;
        return this;
    }

    public Dossier addCategorieCloture(CategorieCloture categorieCloture) {
        this.categorieClotures.add(categorieCloture);
        categorieCloture.setDossier(this);
        return this;
    }

    public Dossier removeCategorieCloture(CategorieCloture categorieCloture) {
        this.categorieClotures.remove(categorieCloture);
        categorieCloture.setDossier(null);
        return this;
    }

    public void setCategorieClotures(Set<CategorieCloture> categorieClotures) {
        this.categorieClotures = categorieClotures;
    }
