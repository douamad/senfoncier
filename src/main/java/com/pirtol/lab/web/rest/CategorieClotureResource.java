...
public class CategorieClotureResource {
    ...
    public ResponseEntity<CategorieClotureDTO> createCategorieCloture(@RequestBody CategorieClotureDTO categorieClotureDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/categorie-clotures/" + result.getId()))
    ...
    public ResponseEntity<CategorieClotureDTO> updateCategorieCloture(@RequestBody CategorieClotureDTO categorieClotureDTO) throws URISyntaxException {
