...
/**
 * REST controller for managing {@link com.pirtol.lab.domain.Usage}.
 */
@RestController
@RequestMapping("/api")
public class UsageResource {
    ...
    public ResponseEntity<UsageDTO> updateUsage(@RequestBody UsageDTO usageDTO) throws URISyntaxException {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, usageDTO.getId().toString()))
            .body(result);
    }
     ...
     */
    @GetMapping("/usages")
    public ResponseEntity<List<UsageDTO>> getAllUsages(Pageable pageable) {
