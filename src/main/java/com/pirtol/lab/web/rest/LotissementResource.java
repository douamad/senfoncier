...
public class LotissementResource {
    ...
    public LotissementResource(LotissementService lotissementService) {
    ...
    public ResponseEntity<LotissementDTO> createLotissement(@RequestBody LotissementDTO lotissementDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/lotissements/" + result.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, result.getId().toString()))
            .body(result);
    }

    /**
     * {@code PUT  /lotissements} : Updates an existing lotissement.
     *
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/lotissements")
    public ResponseEntity<LotissementDTO> updateLotissement(@RequestBody LotissementDTO lotissementDTO) throws URISyntaxException {
        log.debug("REST request to update Lotissement : {}", lotissementDTO);
        if (lotissementDTO.getId() == null) {
    ...
    public ResponseEntity<List<LotissementDTO>> getAllLotissements(Pageable pageable) {
        log.debug("REST request to get a page of Lotissements");
        Page<LotissementDTO> page = lotissementService.findAll(pageable);
