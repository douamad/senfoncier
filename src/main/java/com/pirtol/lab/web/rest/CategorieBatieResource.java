...
public class CategorieBatieResource {
    ...
    public CategorieBatieResource(CategorieBatieService categorieBatieService) {
    ...
    public ResponseEntity<CategorieBatieDTO> createCategorieBatie(@RequestBody CategorieBatieDTO categorieBatieDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/categorie-baties/" + result.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, result.getId().toString()))
            .body(result);
    }

    /**
     * {@code PUT  /categorie-baties} : Updates an existing categorieBatie.
     *
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/categorie-baties")
    public ResponseEntity<CategorieBatieDTO> updateCategorieBatie(@RequestBody CategorieBatieDTO categorieBatieDTO) throws URISyntaxException {
        log.debug("REST request to update CategorieBatie : {}", categorieBatieDTO);
        if (categorieBatieDTO.getId() == null) {
    ...
    public ResponseEntity<List<CategorieBatieDTO>> getAllCategorieBaties(Pageable pageable) {
        log.debug("REST request to get a page of CategorieBaties");
        Page<CategorieBatieDTO> page = categorieBatieService.findAll(pageable);
