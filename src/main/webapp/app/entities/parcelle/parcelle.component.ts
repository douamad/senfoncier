...
export class ParcelleComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.parcelleService
      ...
      .subscribe(
        (res: HttpResponse<IParcelle[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInParcelles(): void {
    this.eventSubscriber = this.eventManager.subscribe('parcelleListModification', () => this.loadPage());
  }
