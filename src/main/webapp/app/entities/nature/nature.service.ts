...
type EntityResponseType = HttpResponse<INature>;
type EntityArrayResponseType = HttpResponse<INature[]>;

@Injectable({ providedIn: 'root' })
export class NatureService {
  public resourceUrl = SERVER_API_URL + 'api/natures';
  ...
  update(nature: INature): Observable<EntityResponseType> {
    return this.http.put<INature>(this.resourceUrl, nature, { observe: 'response' });
  }
