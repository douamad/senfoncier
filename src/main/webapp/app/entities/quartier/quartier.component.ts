...
export class QuartierComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.quartierService
      ...
      .subscribe(
        (res: HttpResponse<IQuartier[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInQuartiers(): void {
    this.eventSubscriber = this.eventManager.subscribe('quartierListModification', () => this.loadPage());
  }
