...
export class CommuneComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.communeService
      ...
      .subscribe(
        (res: HttpResponse<ICommune[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInCommunes(): void {
    this.eventSubscriber = this.eventManager.subscribe('communeListModification', () => this.loadPage());
  }
