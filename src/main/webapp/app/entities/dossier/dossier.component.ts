...
export class DossierComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.dossierService
      ...
      .subscribe(
        (res: HttpResponse<IDossier[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInDossiers(): void {
    this.eventSubscriber = this.eventManager.subscribe('dossierListModification', () => this.loadPage());
  }
