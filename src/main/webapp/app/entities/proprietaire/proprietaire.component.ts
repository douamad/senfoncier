...
export class ProprietaireComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.proprietaireService
      ...
      .subscribe(
        (res: HttpResponse<IProprietaire[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  ngOnInit(): void {
    ...
    this.registerChangeInProprietaires();
  }
  ...
  registerChangeInProprietaires(): void {
    this.eventSubscriber = this.eventManager.subscribe('proprietaireListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IProprietaire[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
