...
public class ArrondissementResourceIT {
    ...
    public void getAllArrondissements() throws Exception {
        ...
        restArrondissementMockMvc
            .perform(get("/api/arrondissements?sort=id,desc"))
    ...
    public void getArrondissement() throws Exception {
        ...
        restArrondissementMockMvc
            .perform(get("/api/arrondissements/{id}", arrondissement.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingArrondissement() throws Exception {
        // Get the arrondissement
        restArrondissementMockMvc.perform(get("/api/arrondissements/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void deleteArrondissement() throws Exception {
        ...
        restArrondissementMockMvc
            .perform(delete("/api/arrondissements/{id}", arrondissement.getId()).accept(MediaType.APPLICATION_JSON))
