...
public class ProprietaireResourceIT {
    ...
    public void getAllProprietaires() throws Exception {
        ...
        restProprietaireMockMvc
            .perform(get("/api/proprietaires?sort=id,desc"))
    ...
    public void getProprietaire() throws Exception {
        ...
        restProprietaireMockMvc
            .perform(get("/api/proprietaires/{id}", proprietaire.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingProprietaire() throws Exception {
        // Get the proprietaire
        restProprietaireMockMvc.perform(get("/api/proprietaires/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void deleteProprietaire() throws Exception {
        ...
        restProprietaireMockMvc
            .perform(delete("/api/proprietaires/{id}", proprietaire.getId()).accept(MediaType.APPLICATION_JSON))
