...
public class DepartementResourceIT {
    ...
    public void createDepartement() throws Exception {
        ...
        restDepartementMockMvc
            .perform(
                post("/api/departements").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(departementDTO))
            )
    ...
    public void updateDepartement() throws Exception {
        ...
        restDepartementMockMvc
            .perform(
                put("/api/departements").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(departementDTO))
            )
            .andExpect(status().isOk());
    ...
    public void deleteDepartement() throws Exception {
        ...
        restDepartementMockMvc
            .perform(delete("/api/departements/{id}", departement.getId()).accept(MediaType.APPLICATION_JSON))
