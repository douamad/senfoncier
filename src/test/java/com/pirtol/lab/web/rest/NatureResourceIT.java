...
public class NatureResourceIT {
    ...
    public void createNature() throws Exception {
        ...
        restNatureMockMvc
            .perform(post("/api/natures").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(natureDTO)))
    ...
    public void getAllNatures() throws Exception {
        ...
        restNatureMockMvc
            .perform(get("/api/natures?sort=id,desc"))
    ...
    public void getNature() throws Exception {
        ...
        // Get the nature
        restNatureMockMvc
            .perform(get("/api/natures/{id}", nature.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingNature() throws Exception {
        // Get the nature
        restNatureMockMvc.perform(get("/api/natures/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void updateNature() throws Exception {
        ...
        restNatureMockMvc
            .perform(put("/api/natures").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(natureDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteNature() throws Exception {
        ...
        // Delete the nature
        restNatureMockMvc
            .perform(delete("/api/natures/{id}", nature.getId()).accept(MediaType.APPLICATION_JSON))
