...
public class ParcelleResourceIT {
    ...
    public void createParcelle() throws Exception {
        ...
        restParcelleMockMvc
            .perform(post("/api/parcelles").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(parcelleDTO)))
    ...
    public void getAllParcelles() throws Exception {
        ...
        restParcelleMockMvc
            .perform(get("/api/parcelles?sort=id,desc"))
    ...
    public void getParcelle() throws Exception {
        ...
        // Get the parcelle
        restParcelleMockMvc
            .perform(get("/api/parcelles/{id}", parcelle.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingParcelle() throws Exception {
        // Get the parcelle
        restParcelleMockMvc.perform(get("/api/parcelles/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void updateParcelle() throws Exception {
        ...
        restParcelleMockMvc
            .perform(put("/api/parcelles").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(parcelleDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteParcelle() throws Exception {
        ...
        // Delete the parcelle
        restParcelleMockMvc
            .perform(delete("/api/parcelles/{id}", parcelle.getId()).accept(MediaType.APPLICATION_JSON))
