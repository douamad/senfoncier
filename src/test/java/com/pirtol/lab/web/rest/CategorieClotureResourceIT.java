...
public class CategorieClotureResourceIT {
    ...
    public void getAllCategorieClotures() throws Exception {
        ...
        restCategorieClotureMockMvc
            .perform(get("/api/categorie-clotures?sort=id,desc"))
    ...
    public void getCategorieCloture() throws Exception {
        ...
        restCategorieClotureMockMvc
            .perform(get("/api/categorie-clotures/{id}", categorieCloture.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingCategorieCloture() throws Exception {
        // Get the categorieCloture
        restCategorieClotureMockMvc.perform(get("/api/categorie-clotures/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void deleteCategorieCloture() throws Exception {
        ...
        restCategorieClotureMockMvc
            .perform(delete("/api/categorie-clotures/{id}", categorieCloture.getId()).accept(MediaType.APPLICATION_JSON))
