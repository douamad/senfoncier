...
public class LotissementResourceIT {
    ...
    public void createLotissement() throws Exception {
        ...
        restLotissementMockMvc.perform(post("/api/lotissements")
    ...
    public void getAllLotissements() throws Exception {
        ...
        restLotissementMockMvc.perform(get("/api/lotissements?sort=id,desc"))
    ...
    public void getLotissement() throws Exception {
        ...
        // Get the lotissement
        restLotissementMockMvc.perform(get("/api/lotissements/{id}", lotissement.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingLotissement() throws Exception {
        // Get the lotissement
        restLotissementMockMvc.perform(get("/api/lotissements/{id}", Long.MAX_VALUE))
    ...
    public void updateLotissement() throws Exception {
        ...
        restLotissementMockMvc.perform(put("/api/lotissements")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(lotissementDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteLotissement() throws Exception {
        ...
        restLotissementMockMvc.perform(delete("/api/lotissements/{id}", lotissement.getId())
