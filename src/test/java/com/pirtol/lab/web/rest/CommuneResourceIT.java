...
public class CommuneResourceIT {
    ...
    public void createCommune() throws Exception {
        ...
        restCommuneMockMvc
            .perform(post("/api/communes").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(communeDTO)))
    ...
    public void getAllCommunes() throws Exception {
        ...
        restCommuneMockMvc
            .perform(get("/api/communes?sort=id,desc"))
    ...
    public void getCommune() throws Exception {
        ...
        // Get the commune
        restCommuneMockMvc
            .perform(get("/api/communes/{id}", commune.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingCommune() throws Exception {
        // Get the commune
        restCommuneMockMvc.perform(get("/api/communes/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void updateCommune() throws Exception {
        ...
        restCommuneMockMvc
            .perform(put("/api/communes").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(communeDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteCommune() throws Exception {
        ...
        // Delete the commune
        restCommuneMockMvc
            .perform(delete("/api/communes/{id}", commune.getId()).accept(MediaType.APPLICATION_JSON))
