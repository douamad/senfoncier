...
public class CategorieBatieResourceIT {
    ...
    public void createCategorieBatie() throws Exception {
        ...
        restCategorieBatieMockMvc.perform(post("/api/categorie-baties")
    ...
    public void getAllCategorieBaties() throws Exception {
        ...
        restCategorieBatieMockMvc.perform(get("/api/categorie-baties?sort=id,desc"))
    ...
    public void getCategorieBatie() throws Exception {
        ...
        restCategorieBatieMockMvc.perform(get("/api/categorie-baties/{id}", categorieBatie.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingCategorieBatie() throws Exception {
        // Get the categorieBatie
        restCategorieBatieMockMvc.perform(get("/api/categorie-baties/{id}", Long.MAX_VALUE))
    ...
    public void deleteCategorieBatie() throws Exception {
        ...
        restCategorieBatieMockMvc.perform(delete("/api/categorie-baties/{id}", categorieBatie.getId())
