...
import { ProprietaireComponent } from 'app/entities/proprietaire/proprietaire.component';
...
describe('Component Tests', () => {
  describe('Proprietaire Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.proprietaires && comp.proprietaires[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
