...
import { LotissementComponent } from 'app/entities/lotissement/lotissement.component';
...
describe('Component Tests', () => {
  describe('Lotissement Management Component', () => {
    let comp: LotissementComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LotissementComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.lotissements && comp.lotissements[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
