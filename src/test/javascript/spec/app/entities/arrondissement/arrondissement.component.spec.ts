...
import { ArrondissementComponent } from 'app/entities/arrondissement/arrondissement.component';
...
describe('Component Tests', () => {
  describe('Arrondissement Management Component', () => {
    let comp: ArrondissementComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ArrondissementComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.arrondissements && comp.arrondissements[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
