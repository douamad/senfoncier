...
describe('Service Tests', () => {
  describe('Dossier Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Dossier(0, 'AAAAAAA', 0, 0, 0, 0, 0, 0, 0, 'AAAAAAA', 0, 0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
        ...
        const returnedFromService = Object.assign(
          {
            ...
            montantLoyer: 1,
            superficieBatie: 1,
            coeffCorrectifBatie: 1,
            valeurBatie: 1,
            lineaireCloture: 1,
            coeffCloture: 1,
            valeurCloture: 1,
            amenagementSpaciaux: 'BBBBBB',
            valeurAmenagement: 1,
            valeurVenale: 1,
            valeurLocativ: 'BBBBBB',
            paysAdresse: 'BBBBBB',
            villeAdresse: 'BBBBBB',
          },
          elemDefault
